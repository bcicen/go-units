...
var convTests = []conversionTest{
	...
	{"kilobyte", "petabyte", "0.000000000000909495"},
	{"kilobyte", "yottabyte", "0.000000000000000000000847033"},
	{"kilobyte", "exabyte", "0.000000000000000888178"},
	{"kilobyte", "gigabit", "0.000008192"},
	{"kilobyte", "bit", "8192"},
	{"kilobyte", "nibble", "2048"},
	{"kilobyte", "megabit", "0.008192"},
	{"kilobyte", "zettabyte", "0.000000000000000000867362"},
	{"kilobyte", "byte", "1024"},
	{"kilobyte", "petabit", "0.000000000008192"},
	{"kilobyte", "megabyte", "0.000976562"},
	{"kilobyte", "exabit", "0.000000000000008192"},
	{"kilobyte", "terabit", "0.000000008192"},
	{"kilobyte", "terabyte", "0.000000000931323"},
	{"kilobyte", "gigabyte", "0.000000953674"},
	{"kilobyte", "kilobit", "8.192"},
	{"petabyte", "kilobyte", "1099511627776"},
	{"petabyte", "yottabyte", "0.000000000931323"},
	{"petabyte", "exabyte", "0.000976562"},
	{"petabyte", "gigabit", "9007199.254741"},
	{"petabyte", "bit", "9007199254740992"},
	{"petabyte", "nibble", "2251799813685248"},
	{"petabyte", "megabit", "9007199254.740992"},
	{"petabyte", "zettabyte", "0.000000953674"},
	{"petabyte", "byte", "1125899906842624"},
	{"petabyte", "petabit", "9.007199"},
	{"petabyte", "megabyte", "1073741824"},
	{"petabyte", "exabit", "0.0090072"},
	{"petabyte", "terabit", "9007.199255"},
	{"petabyte", "terabyte", "1024"},
	{"petabyte", "gigabyte", "1048576"},
	{"petabyte", "kilobit", "9007199254740.992188"},
	{"yottabyte", "kilobyte", "1180591620717411303424"},
	{"yottabyte", "petabyte", "1073741824"},
	{"yottabyte", "exabyte", "1048576"},
	{"yottabyte", "gigabit", "9671406556917034"},
	{"yottabyte", "bit", "9671406556917033397649408"},
	{"yottabyte", "nibble", "2417851639229258349412352"},
	{"yottabyte", "megabit", "9671406556917032960"},
	{"yottabyte", "zettabyte", "1024"},
	{"yottabyte", "byte", "1208925819614629174706176"},
	{"yottabyte", "petabit", "9671406556.917034"},
	{"yottabyte", "megabyte", "1152921504606846976"},
	{"yottabyte", "exabit", "9671406.556917"},
	{"yottabyte", "terabit", "9671406556917.033203"},
	{"yottabyte", "terabyte", "1099511627776"},
	{"yottabyte", "gigabyte", "1125899906842624"},
	{"yottabyte", "kilobit", "9671406556917033598976"},
	{"exabyte", "kilobyte", "1125899906842624"},
	{"exabyte", "petabyte", "1024"},
	{"exabyte", "yottabyte", "0.000000953674"},
	{"exabyte", "gigabit", "9223372036.854776"},
	{"exabyte", "bit", "9223372036854775808"},
	{"exabyte", "nibble", "2305843009213693952"},
	{"exabyte", "megabit", "9223372036854.775391"},
	{"exabyte", "zettabyte", "0.000976562"},
	{"exabyte", "byte", "1152921504606846976"},
	{"exabyte", "petabit", "9223.372037"},
	{"exabyte", "megabyte", "1099511627776"},
	{"exabyte", "exabit", "9.223372"},
	{"exabyte", "terabit", "9223372.036855"},
	{"exabyte", "terabyte", "1048576"},
	{"exabyte", "gigabyte", "1073741824"},
	{"exabyte", "kilobit", "9223372036854776"},
	{"gigabit", "kilobyte", "122070.3125"},
	{"gigabit", "petabyte", "0.0000001110223"},
	{"gigabit", "yottabyte", "0.0000000000000001033976"},
	{"gigabit", "exabyte", "0.0000000001084202"},
	{"gigabit", "bit", "1000000000"},
	{"gigabit", "nibble", "250000000"},
	{"gigabit", "megabit", "1000"},
	{"gigabit", "zettabyte", "0.0000000000001058791"},
	{"gigabit", "byte", "125000000"},
	{"gigabit", "petabit", "0.000001"},
	{"gigabit", "megabyte", "119.20929"},
	{"gigabit", "exabit", "0.000000001"},
	{"gigabit", "terabit", "0.001"},
	{"gigabit", "terabyte", "0.0001136868"},
	{"gigabit", "gigabyte", "0.1164153"},
	{"gigabit", "kilobit", "1000000"},
	{"bit", "kilobyte", "0.0001220703"},
	{"bit", "petabyte", "0.0000000000000001110223"},
	{"bit", "yottabyte", "0.0000000000000000000000001033976"},
	{"bit", "exabyte", "0.0000000000000000001084202"},
	{"bit", "gigabit", "0.000000001"},
	{"bit", "nibble", "0.25"},
	{"bit", "megabit", "0.000001"},
	{"bit", "zettabyte", "0.0000000000000000000001058791"},
	{"bit", "byte", "0.125"},
	{"bit", "petabit", "0.000000000000001"},
	{"bit", "megabyte", "0.0000001192093"},
	{"bit", "exabit", "0.000000000000000001"},
	{"bit", "terabit", "0.000000000001"},
	{"bit", "terabyte", "0.0000000000001136868"},
	{"bit", "gigabyte", "0.0000000001164153"},
	{"bit", "kilobit", "0.001"},
	{"nibble", "kilobyte", "0.000488281"},
	{"nibble", "petabyte", "0.000000000000000444089"},
	{"nibble", "yottabyte", "0.00000000000000000000000041359"},
	{"nibble", "exabyte", "0.000000000000000000433681"},
	{"nibble", "gigabit", "0.000000004"},
	{"nibble", "bit", "4"},
	{"nibble", "megabit", "0.000004"},
	{"nibble", "zettabyte", "0.000000000000000000000423516"},
	{"nibble", "byte", "0.5"},
	{"nibble", "petabit", "0.000000000000004"},
	{"nibble", "megabyte", "0.000000476837"},
	{"nibble", "exabit", "0.000000000000000004"},
	{"nibble", "terabit", "0.000000000004"},
	{"nibble", "terabyte", "0.000000000000454747"},
	{"nibble", "gigabyte", "0.000000000465661"},
	{"nibble", "kilobit", "0.004"},
	{"megabit", "kilobyte", "122.070312"},
	{"megabit", "petabyte", "0.0000000001110223"},
	{"megabit", "yottabyte", "0.0000000000000000001033976"},
	{"megabit", "exabyte", "0.0000000000001084202"},
	{"megabit", "gigabit", "0.001"},
	{"megabit", "bit", "1000000"},
	{"megabit", "nibble", "250000"},
	{"megabit", "zettabyte", "0.0000000000000001058791"},
	{"megabit", "byte", "125000"},
	{"megabit", "petabit", "0.000000001"},
	{"megabit", "megabyte", "0.1192093"},
	{"megabit", "exabit", "0.000000000001"},
	{"megabit", "terabit", "0.000001"},
	{"megabit", "terabyte", "0.0000001136868"},
	{"megabit", "gigabyte", "0.0001164153"},
	{"megabit", "kilobit", "1000"},
	{"zettabyte", "kilobyte", "1152921504606846976"},
	{"zettabyte", "petabyte", "1048576"},
	{"zettabyte", "yottabyte", "0.000976562"},
	{"zettabyte", "exabyte", "1024"},
	{"zettabyte", "gigabit", "9444732965739.291016"},
	{"zettabyte", "bit", "9444732965739290427392"},
	{"zettabyte", "nibble", "2361183241434822606848"},
	{"zettabyte", "megabit", "9444732965739290"},
	{"zettabyte", "byte", "1180591620717411303424"},
	{"zettabyte", "petabit", "9444732.965739"},
	{"zettabyte", "megabyte", "1125899906842624"},
	{"zettabyte", "exabit", "9444.732966"},
	{"zettabyte", "terabit", "9444732965.73929"},
	{"zettabyte", "terabyte", "1073741824"},
	{"zettabyte", "gigabyte", "1099511627776"},
	{"zettabyte", "kilobit", "9444732965739290624"},
	{"byte", "kilobyte", "0.000976562"},
	{"byte", "petabyte", "0.000000000000000888178"},
	{"byte", "yottabyte", "0.000000000000000000000000827181"},
	{"byte", "exabyte", "0.000000000000000000867362"},
	{"byte", "gigabit", "0.000000008"},
	{"byte", "bit", "8"},
	{"byte", "nibble", "2"},
	{"byte", "megabit", "0.000008"},
	{"byte", "zettabyte", "0.000000000000000000000847033"},
	{"byte", "petabit", "0.000000000000008"},
	{"byte", "megabyte", "0.000000953674"},
	{"byte", "exabit", "0.000000000000000008"},
	{"byte", "terabit", "0.000000000008"},
	{"byte", "terabyte", "0.000000000000909495"},
	{"byte", "gigabyte", "0.000000000931323"},
	{"byte", "kilobit", "0.008"},
	{"petabit", "kilobyte", "122070312500"},
	{"petabit", "petabyte", "0.1110223"},
	{"petabit", "yottabyte", "0.0000000001033976"},
	{"petabit", "exabyte", "0.0001084202"},
	{"petabit", "gigabit", "1000000"},
	{"petabit", "bit", "1000000000000000"},
	{"petabit", "nibble", "250000000000000"},
	{"petabit", "megabit", "1000000000"},
	{"petabit", "zettabyte", "0.0000001058791"},
	{"petabit", "byte", "125000000000000"},
	{"petabit", "megabyte", "119209289.550781"},
	{"petabit", "exabit", "0.001"},
	{"petabit", "terabit", "1000"},
	{"petabit", "terabyte", "113.686838"},
	{"petabit", "gigabyte", "116415.321827"},
	{"petabit", "kilobit", "1000000000000"},
	{"megabyte", "kilobyte", "1024"},
	{"megabyte", "petabyte", "0.000000000931323"},
	{"megabyte", "yottabyte", "0.000000000000000000867362"},
	{"megabyte", "exabyte", "0.000000000000909495"},
	{"megabyte", "gigabit", "0.00838861"},
	{"megabyte", "bit", "8388608"},
	{"megabyte", "nibble", "2097152"},
	{"megabyte", "megabit", "8.388608"},
	{"megabyte", "zettabyte", "0.000000000000000888178"},
	{"megabyte", "byte", "1048576"},
	{"megabyte", "petabit", "0.00000000838861"},
	{"megabyte", "exabit", "0.00000000000838861"},
	{"megabyte", "terabit", "0.00000838861"},
	{"megabyte", "terabyte", "0.000000953674"},
	{"megabyte", "gigabyte", "0.000976562"},
	{"megabyte", "kilobit", "8388.608"},
	{"exabit", "kilobyte", "122070312500000"},
	{"exabit", "petabyte", "111.022302"},
	{"exabit", "yottabyte", "0.0000001033976"},
	{"exabit", "exabyte", "0.1084202"},
	{"exabit", "gigabit", "1000000000"},
	{"exabit", "bit", "1000000000000000000"},
	{"exabit", "nibble", "250000000000000000"},
	{"exabit", "megabit", "1000000000000"},
	{"exabit", "zettabyte", "0.0001058791"},
	{"exabit", "byte", "125000000000000000"},
	{"exabit", "petabit", "1000"},
	{"exabit", "megabyte", "119209289550.78125"},
	{"exabit", "terabit", "1000000"},
	{"exabit", "terabyte", "113686.837722"},
	{"exabit", "gigabyte", "116415321.826935"},
	{"exabit", "kilobit", "1000000000000000"},
	{"terabit", "kilobyte", "122070312.5"},
	{"terabit", "petabyte", "0.0001110223"},
	{"terabit", "yottabyte", "0.0000000000001033976"},
	{"terabit", "exabyte", "0.0000001084202"},
	{"terabit", "gigabit", "1000"},
	{"terabit", "bit", "1000000000000"},
	{"terabit", "nibble", "250000000000"},
	{"terabit", "megabit", "1000000"},
	{"terabit", "zettabyte", "0.0000000001058791"},
	{"terabit", "byte", "125000000000"},
	{"terabit", "petabit", "0.001"},
	{"terabit", "megabyte", "119209.289551"},
	{"terabit", "exabit", "0.000001"},
	{"terabit", "terabyte", "0.1136868"},
	{"terabit", "gigabyte", "116.415322"},
	{"terabit", "kilobit", "1000000000"},
	{"terabyte", "kilobyte", "1073741824"},
	{"terabyte", "petabyte", "0.000976562"},
	{"terabyte", "yottabyte", "0.000000000000909495"},
	{"terabyte", "exabyte", "0.000000953674"},
	{"terabyte", "gigabit", "8796.093022"},
	{"terabyte", "bit", "8796093022208"},
	{"terabyte", "nibble", "2199023255552"},
	{"terabyte", "megabit", "8796093.022208"},
	{"terabyte", "zettabyte", "0.000000000931323"},
	{"terabyte", "byte", "1099511627776"},
	{"terabyte", "petabit", "0.00879609"},
	{"terabyte", "megabyte", "1048576"},
	{"terabyte", "exabit", "0.00000879609"},
	{"terabyte", "terabit", "8.796093"},
	{"terabyte", "gigabyte", "1024"},
	{"terabyte", "kilobit", "8796093022.208"},
	{"gigabyte", "kilobyte", "1048576"},
	{"gigabyte", "petabyte", "0.000000953674"},
	{"gigabyte", "yottabyte", "0.000000000000000888178"},
	{"gigabyte", "exabyte", "0.000000000931323"},
	{"gigabyte", "gigabit", "8.589935"},
	{"gigabyte", "bit", "8589934592"},
	{"gigabyte", "nibble", "2147483648"},
	{"gigabyte", "megabit", "8589.934592"},
	{"gigabyte", "zettabyte", "0.000000000000909495"},
	{"gigabyte", "byte", "1073741824"},
	{"gigabyte", "petabit", "0.00000858993"},
	{"gigabyte", "megabyte", "1024"},
	{"gigabyte", "exabit", "0.00000000858993"},
	{"gigabyte", "terabit", "0.00858993"},
	{"gigabyte", "terabyte", "0.000976562"},
	{"gigabyte", "kilobit", "8589934.592"},
	{"kilobit", "kilobyte", "0.1220703"},
	{"kilobit", "petabyte", "0.0000000000001110223"},
	{"kilobit", "yottabyte", "0.0000000000000000000001033976"},
	{"kilobit", "exabyte", "0.0000000000000001084202"},
	{"kilobit", "gigabit", "0.000001"},
	{"kilobit", "bit", "1000"},
	{"kilobit", "nibble", "250"},
	{"kilobit", "megabit", "0.001"},
	{"kilobit", "zettabyte", "0.0000000000000000001058791"},
	{"kilobit", "byte", "125"},
	{"kilobit", "petabit", "0.000000000001"},
	{"kilobit", "megabyte", "0.0001192093"},
	{"kilobit", "exabit", "0.000000000000001"},
	{"kilobit", "terabit", "0.000000001"},
	{"kilobit", "terabyte", "0.0000000001136868"},
	{"kilobit", "gigabyte", "0.0000001164153"},
